...
export default function EditScanScreen({navigation}) {
      ...
      <ScrollView>
        <View
          ...
          <Image
            ...
            source={{
              uri: 'https://fingerscanimages.s3.ap-south-1.amazonaws.com/scan/modify.png',
            }}
            resizeMode={'contain'}
          />
        </View>
        <View
          ...
          <View
            ...
            <Text style={{color:'#fff'}}>Edit Fingerprints</Text>
          </View>
          <View
            style={{
              flex: 0.5,
        ...
        <View
          ...
          <Image
            ...
            source={{
              uri: 'https://fingerscanimages.s3.ap-south-1.amazonaws.com/scan/edit_the_fingerprints.png',
            }}
            resizeMode={'contain'}
          />
        </View>
